...
{
    public class ByteCodec : IValueCodec<byte>, IValueCodec<sbyte>, IValueCodec<int>, IValueCodec<uint>, IValueCodec<short>, IValueCodec<ushort>, IValueCodec<long>, IValueCodec<ulong>
    {
        void IValueCodec<byte>.WriteField(Writer writer, SerializationContext context, uint fieldId, Type expectedType, byte value)
        {
        ...
        void IValueCodec<sbyte>.WriteField(Writer writer, SerializationContext context, uint fieldId, Type expectedType, sbyte value)
        {
        ...
        void IValueCodec<short>.WriteField(Writer writer, SerializationContext context, uint fieldId, Type expectedType, short value)
        {
        ...
        void IValueCodec<ushort>.WriteField(Writer writer, SerializationContext context, uint fieldId, Type expectedType, ushort value)
        {
        ...
        void IValueCodec<uint>.WriteField(Writer writer, SerializationContext context, uint fieldId, Type expectedType, uint value)
        {
            writer.WriteUInt32Field(context, fieldId, expectedType, value);
        }
        ...
        void IValueCodec<int>.WriteField(Writer writer, SerializationContext context, uint fieldId, Type expectedType, int value)
        {
            writer.WriteInt32Field(context, fieldId, expectedType, value);
        }
        ...
        {
            writer.WriteInt64Field(context, fieldId, expectedType, value);
        }
        ...
        void IValueCodec<ulong>.WriteField(Writer writer, SerializationContext context, uint fieldId, Type expectedType, ulong value)
        {
            writer.WriteUInt64Field(context, fieldId, expectedType, value);
        }
