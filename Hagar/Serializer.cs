...
namespace Hagar
{
    ...
    public static class WireCodec
    {
        ...
        public static void WriteFieldHeader(this Writer writer, SerializationContext context, uint fieldId, Type expectedType, Type actualType, WireType wireType)
        {
            ...
            if (field.HasExtendedFieldId) writer.Write(field.FieldId);
        ...
        public static Field ReadFieldHeader(this Reader reader, SerializationContext context)
        {
            ...
            if (field.HasExtendedFieldId) field.FieldId = reader.ReadUInt();
...
namespace Hagar.Exceptions
{
    ...
    {
        public ExtendedWireTypeInvalidException() : base("Attempted to access the extended wire type from a tag which does not have an extended wire type.")
        {
        }
    }
}
