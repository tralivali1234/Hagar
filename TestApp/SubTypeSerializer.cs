...
namespace TestApp
{
    ...
    {
        public class SubTypeSerializer<TBaseSerializer, TStringCodec, TIntCodec> : IPartialSerializer<SubType> where TBaseSerializer : IPartialSerializer<BaseType> where TStringCodec : IValueCodec<string> where TIntCodec : IValueCodec<int>
        {
